...
<body>
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-floating mt-2">
                                <select name="program" class="form-select" id="floatingSelect"
    ...
    $(document).ready(function() {
        // event ketika form telah disubmit
        $("form").submit(function(event) {
            ...
            var programPelatihan = $("#floatingSelect").val();
            var tahunDaftar = $("#fsTahun").val();
            ...
            $.ajax({
                ...
                beforeSend: function(result){
                    $(".spinner-border").show(100)
                },
                success: function(result) {
                    $(".spinner-border").hide(100000)
                    $("tbody").append(result);
                    $("form")[0].reset();
                }
            })
